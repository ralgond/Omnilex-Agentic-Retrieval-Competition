...
tokenizer = AutoTokenizer.from_pretrained("../ft_data/lora_reranker_output_30000_e1_0-145")
...
model = PeftModel.from_pretrained(base, "../ft_data/lora_reranker_output_30000_e1_0-145")
