...
model_dir = snapshot_download('BAAI/bge-reranker-v2-gemma', local_dir='/root/autodl-fs/bge-reranker-v2-gemma')
# model_dir = snapshot_download('Qwen/Qwen3.5-9B')
# model_dir = snapshot_download('Qwen/Qwen2.5-7B-Instruct')

# model_dir = snapshot_download('BAAI/bge-reranker-v2.5-gemma2-lightweight', local_dir='/root/autodl-fs/bge-reranker-v2.5-gemma2-lightweight')
print(f"{model_dir}")